This file contains the first discussion about editing use cases of the editing server in the general perspective (i.e from both client and server non exhaustive perspective). 
