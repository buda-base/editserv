...
<body>
<h1>Task submit status</h1>
<div>
<h2>${status}</h2>
<br>
<input name="Refresh" value="Refresh status" class="button" onClick="location.href='/taskStatus/${taskId}'" type="button">
</div>
    <div>
    <p><b>Task Id:</b> ${taskId}</p>
    <c:if test = "${task.getId()!=null}">
